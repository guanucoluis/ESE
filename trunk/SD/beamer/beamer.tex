...
\begin{frame}{\insertsection{}}
  ...
  \begin{description}
    \only<1>{\item[Cliente-Servidor:] La independencia del cliente hacia el
    ...
    \only<2>{\item[Sin-estado:] El servidor no debe almacenar ninguna
    ...
    \only<3>{\item[Cache:] Mejorar la eficiencia de la red. Lo
      ...
      reutilizado.}
    \only<4>{\item[Interface Uniforme:] Una de las características
